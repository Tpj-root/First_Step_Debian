...
\begin{center}
    \begin{tikzpicture}[scale=0.1] % Scale to match mm units
        ...
        % Draw diagonal grid lines (45-degree)
        \foreach \x in {-270,-260,...,190} { % Extending beyond to cover the area
            \draw[thin,gray] (\x, 0) -- (\x+270, 270); % 45-degree lines
        }

        % Draw bold diagonal lines every 10mm
        \foreach \x in {-270,-260,...,190} {
            \draw[thick,black] (\x, 0) -- (\x+270, 270);
        }
